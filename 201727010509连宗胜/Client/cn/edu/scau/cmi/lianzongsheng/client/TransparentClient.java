...
public class TransparentClient extends Application {
    @Override
    public void start(Stage primaryStage) throws Exception {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/cn/edu/scau/cmi/lianzongsheng/transparentcomposite/TransparentComposite.fxml"));//修改了
